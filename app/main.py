...
from app.routers.Seccion import router as seccion_router
from app.routers.PuntajeEquipo import router as puntajeEquipo_router
from app.routers.Inscripcion import router as inscripcion_router
